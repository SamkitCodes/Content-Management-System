...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
            ...
            <!-- Removed everything except blog cards from main content of the page -->
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                <?php
                                // Getting the theme name from link
                                $name = $_GET['title'];
                                ...
                                <!-- <h2 class="fw-bolder">Theme Collection</h2> -->
                            </div>
                        </div>
                    </div>
                    <div class="row gx-5">
                    ...
                    <?php
                        ...
                        // opening the file to read input
                        ...
                        JOIN artwork ON themes.ThemeID = artwork.ThemeID
                        JOIN artists ON artwork.ArtistID = artists.ArtistID
                        WHERE themes.Theme = \"$name\"";
                                ...
                                <div class="col-lg-4 mb-5">
                                    <div class="card h-100 shadow border-0">
                                        ...
                                        <div class="card-body p-4">
                                            <h5 class="card-title mb-3"><a href = "aboutArtist.php?title=$artistName">$artistName</a></h5>
                                            <p class="card-text mb-0">$artName</p>
                                        </div>
                                    </div>
                                </div>
